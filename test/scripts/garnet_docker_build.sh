...
#CMD_STRING="cd GarnetFlow/scripts; ./build_halide_distrib.sh StanfordAHA/Halide-to-Hardware $TRAVIS_COMMIT"
...
docker exec -i halide-hw-distro -e COMMIT=$TRAVIS_COMMIT bash -c "cd GarnetFlow/scripts/; ./build_halide_distrib.sh StanfordAHA/Halide-to-Hardware $COMMIT"
