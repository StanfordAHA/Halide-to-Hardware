...
bool contain_for_loop(Stmt s) {
  ...
  CodeGen_Clockwork_Target::CodeGen_Clockwork_Target(const string &name, Target target)
    : target_name(name),
      ...
      //srcc(src_stream, target) { }
  //srcc(std::cout, target, CodeGen_Clockwork_C::CPlusPlusImplementation) { }
//srcc(std::cout, target, CodeGen_Clockwork_C::CPlusPlusHeader) { }
...
void CodeGen_Clockwork_Target::init_module() {
    ...
    hdr_stream << clockwork_header_includes << '\n';
