...
typedef enum halide_target_feature_t {
    ...
    halide_target_feature_pono = 65, ///< Enable output to Clockwork
    halide_target_feature_use_extract_hw_kernel = 66, ///< Enable old hwkernel functionality instead of unified buffer
    halide_target_feature_bfloat_hardware = 67, ///< Enable use of bfloat hardware in hardware accelerators as oppoosed to float
    halide_target_feature_enable_ponds = 68, ///< Enable Clockwork to map memories to ponds  in hardware accelerators in addition to memory tiles
